...
document.addEventListener('click', (e) => {
    ...
    if (anchor && anchor.href && anchor.href.startsWith(window.location.origin + '/admin')) {
        ...
        // These sections use page-specific layouts/styles; force full reload to avoid broken UI state
        if (anchor.href.includes('/admin/inventory') || anchor.href.includes('/admin/purchase-orders')) {
