    ...
    @else
        <main class="container mx-auto px-4 py-6 md:py-10">
            ...
            <section id="featured-video" class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <!-- Trình phát video chính (Chiếm 2 cột) -->
                <div class="lg:col-span-2 video-card p-4 md:p-6 flex flex-col justify-between">
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4">
                        ...
                        <div id="source-switcher" class="flex items-center gap-1 bg-slate-100 p-1 rounded-xl self-start text-[11px] font-bold text-gray-700 {{ !$featured_video->youtube_url ? 'hidden' : '' }}">
                            <span class="px-1.5 text-gray-500 uppercase text-[9px]">Nguồn:</span>
                            <button id="src-mp4-btn" onclick="switchSource('mp4')" class="px-2.5 py-1 rounded-lg bg-primary text-white shadow-sm transition-all source-switcher-btn active">
                                <i class="fa-solid fa-file-video mr-1"></i> MP4
                            </button>
                            <button id="src-yt-btn" onclick="switchSource('youtube')" class="px-2.5 py-1 rounded-lg hover:bg-white transition-all text-red-600 source-switcher-btn">
                    ...
                    <div class="video-player-frame mb-4">
                        ...
                        <div id="mp4-player-container" class="w-full h-full">
                            <video id="main-video-player" class="w-full h-full object-cover animate-fade-in" controls preload="auto" poster="{{ $getThumbUrl($featured_video->thumbnail_path) }}" src="{{ $getVideoUrl($featured_video->video_path) }}">
