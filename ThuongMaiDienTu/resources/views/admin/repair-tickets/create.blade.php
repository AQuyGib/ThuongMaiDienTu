        ...
        <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm space-y-4">
            ...
            <div class="grid gap-4 md:grid-cols-3">
                <div>
                    ...
                    <input type="number" name="estimated_cost" value="{{ old('estimated_cost', 0) }}" class="w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required min="0">
                </div>
