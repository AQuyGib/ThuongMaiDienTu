        ...
        <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm space-y-4">
            ...
            <div class="grid gap-4 md:grid-cols-3">
                <div>
                    ...
                    <input type="number" step="0.01" name="subtotal" id="subtotal" value="{{ old('subtotal', $serviceInvoice->subtotal) }}" class="w-full rounded-lg border {{ $errors->has('subtotal') ? 'border-red-400 ring-1 ring-red-400' : 'border-gray-300' }} bg-white px-3 py-2 text-sm shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required min="0">
