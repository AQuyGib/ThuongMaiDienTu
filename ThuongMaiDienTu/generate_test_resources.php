<?php
$baseDir = dirname(__DIR__) . '/tai_lieu_kiem_thu';

// Tạo cấu trúc các thư mục con đầy đủ
...
// 1. Tạo các file hình ảnh hợp lệ (chuỗi base64 thực tế)
...
echo "1. Da tao xong thu muc images/ chua cac dinh dang: .png, .jpg, .webp, .gif, .svg\n";

// 2. Tạo các file video hợp lệ (mp4, mkv giả lập)
...
echo "2. Da tao xong thu muc videos/ chua cac dinh dang: .mp4, .mkv\n";

// 3. Tạo các file âm thanh hợp lệ (mp3, wav, ogg giả lập)
$mp3Hex = '49443303000000000000'; // ID3 Tag
$wavHex = '524946462408000057415645666d74201000000001000100401f0000401f0000010008006461746100080000'; // RIFF WAVE
$oggHex = '4f676753000200000000000000000000000000000000'; // OggS
...
echo "3. Da tao xong thu muc audio/ chua cac dinh dang: .mp3, .wav, .ogg\n";

// 4. Tạo các file tài liệu đính kèm (pdf, docx, pptx, txt)
...
echo "4. Da tao xong thu muc documents/ chua cac dinh dang: .pdf, .docx, .pptx, .txt\n";

// 5. Tạo các file bảng tính Excel & CSV phục vụ Import sản phẩm
...
// Tao file XLSX mockup
file_put_contents($baseDir . '/spreadsheets/products_import_excel.xlsx', hex2bin($docxHex));
echo "5. Da tao xong thu muc spreadsheets/ chua cac dinh dang: .csv, .xlsx\n";

// 6. Tạo các file nén (zip, rar, 7z)
$zipHex = '504b0506000000000000000000000000000000000000'; // End of central directory record
$rarHex = '526172211a0700'; // Rar! header
$sevenZHex = '377abcaf271c0003'; // 7z header
...
echo "6. Da tao xong thu muc archives/ chua cac dinh dang: .zip, .rar, .7z\n";

// 7. Tạo các file dữ liệu web (json, xml, html)
...
echo "7. Da tao xong thu muc web_data/ chua cac dinh dang: .json, .xml, .html\n";

echo "\n=== HOAN TAT TAO THU MUC TAI LIEU KIEM THU ===\n";
