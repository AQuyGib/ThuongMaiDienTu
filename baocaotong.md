...
![Cấu trúc giao diện](images/ui_layout_1.png)

*Hình 7.1.1: Bản vẽ thiết kế bố cục giao diện (UI Layout) của chức năng ĐĂNG NHẬP / ĐĂNG KÝ ĐA KÊNH.*
...
*Hình 7.1.2: Sơ đồ Use-case mô tả các tác nhân tương tác với chức năng ĐĂNG NHẬP / ĐĂNG KÝ ĐA KÊNH.*
...
*Hình 7.1.3: Sơ đồ hoạt động (Activity Diagram) thể hiện quy trình xử lý của chức năng ĐĂNG NHẬP / ĐĂNG KÝ ĐA KÊNH.*
...
![Cấu trúc giao diện](images/ui_layout_2.png)

*Hình 7.2.1: Bản vẽ thiết kế bố cục giao diện (UI Layout) của chức năng XÁC THỰC 2 LỚP BẢO MẬT (TWO-FACTOR AUTHENTICATION - 2FA).*
...
*Hình 7.2.2: Sơ đồ Use-case mô tả các tác nhân tương tác với chức năng XÁC THỰC 2 LỚP BẢO MẬT (TWO-FACTOR AUTHENTICATION - 2FA).*
...
*Hình 7.2.3: Sơ đồ hoạt động (Activity Diagram) thể hiện quy trình xử lý của chức năng XÁC THỰC 2 LỚP BẢO MẬT (TWO-FACTOR AUTHENTICATION - 2FA).*
...
![Cấu trúc giao diện](images/ui_layout_3.png)

*Hình 7.3.1: Bản vẽ thiết kế bố cục giao diện (UI Layout) của chức năng KHÔI PHỤC MẬT KHẨU.*
...
*Hình 7.3.2: Sơ đồ Use-case mô tả các tác nhân tương tác với chức năng KHÔI PHỤC MẬT KHẨU.*
...
*Hình 7.3.3: Sơ đồ hoạt động (Activity Diagram) thể hiện quy trình xử lý của chức năng KHÔI PHỤC MẬT KHẨU.*
...
![Cấu trúc giao diện](images/ui_layout_4.png)

*Hình 7.4.1: Bản vẽ thiết kế bố cục giao diện (UI Layout) của chức năng LỊCH SỬ ĐĂNG NHẬP BẢO MẬT (LOGIN HISTORY).*
...
*Hình 7.4.2: Sơ đồ Use-case mô tả các tác nhân tương tác với chức năng LỊCH SỬ ĐĂNG NHẬP BẢO MẬT (LOGIN HISTORY).*
...
*Hình 7.4.3: Sơ đồ hoạt động (Activity Diagram) thể hiện quy trình xử lý của chức năng LỊCH SỬ ĐĂNG NHẬP BẢO MẬT (LOGIN HISTORY).*
...
![Cấu trúc giao diện](images/ui_layout_5.png)

*Hình 7.5.1: Bản vẽ thiết kế bố cục giao diện (UI Layout) của chức năng PHÂN QUYỀN NHÂN VIÊN (RBAC).*
...
*Hình 7.5.2: Sơ đồ Use-case mô tả các tác nhân tương tác với chức năng PHÂN QUYỀN NHÂN VIÊN (RBAC).*
...
*Hình 7.5.3: Sơ đồ hoạt động (Activity Diagram) thể hiện quy trình xử lý của chức năng PHÂN QUYỀN NHÂN VIÊN (RBAC).*
...
![Cấu trúc giao diện](images/ui_layout_6.png)

*Hình 7.6.1: Bản vẽ thiết kế bố cục giao diện (UI Layout) của chức năng QUẢN LÝ NHÂN VIÊN & KPI.*
...
*Hình 7.6.2: Sơ đồ Use-case mô tả các tác nhân tương tác với chức năng QUẢN LÝ NHÂN VIÊN & KPI.*
...
*Hình 7.6.3: Sơ đồ hoạt động (Activity Diagram) thể hiện quy trình xử lý của chức năng QUẢN LÝ NHÂN VIÊN & KPI.*
...
![Cấu trúc giao diện](images/ui_layout_7.png)

*Hình 7.7.1: Bản vẽ thiết kế bố cục giao diện (UI Layout) của chức năng ACTIVITY LOGS (NHẬT KÝ HOẠT ĐỘNG HỆ THỐNG).*
...
*Hình 7.7.2: Sơ đồ Use-case mô tả các tác nhân tương tác với chức năng ACTIVITY LOGS (NHẬT KÝ HOẠT ĐỘNG HỆ THỐNG).*
...
*Hình 7.7.3: Sơ đồ hoạt động (Activity Diagram) thể hiện quy trình xử lý của chức năng ACTIVITY LOGS (NHẬT KÝ HOẠT ĐỘNG HỆ THỐNG).*
...
![Cấu trúc giao diện](images/ui_layout_8.png)

*Hình 7.8.1: Bản vẽ thiết kế bố cục giao diện (UI Layout) của chức năng CRUD DANH MỤC ĐA CẤP.*
...
*Hình 7.8.2: Sơ đồ Use-case mô tả các tác nhân tương tác với chức năng CRUD DANH MỤC ĐA CẤP.*
...
*Hình 7.8.3: Sơ đồ hoạt động (Activity Diagram) thể hiện quy trình xử lý của chức năng CRUD DANH MỤC ĐA CẤP.*
...
![Cấu trúc giao diện](images/ui_layout_9.png)

*Hình 7.9.1: Bản vẽ thiết kế bố cục giao diện (UI Layout) của chức năng CRUD SẢN PHẨM & BIẾN THỂ.*
...
*Hình 7.9.2: Sơ đồ Use-case mô tả các tác nhân tương tác với chức năng CRUD SẢN PHẨM & BIẾN THỂ.*
...
*Hình 7.9.3: Sơ đồ hoạt động (Activity Diagram) thể hiện quy trình xử lý của chức năng CRUD SẢN PHẨM & BIẾN THỂ.*
...
![Cấu trúc giao diện](images/ui_layout_10.png)

*Hình 7.10.1: Bản vẽ thiết kế bố cục giao diện (UI Layout) của chức năng IMPORT / EXPORT EXCEL.*
...
*Hình 7.10.2: Sơ đồ Use-case mô tả các tác nhân tương tác với chức năng IMPORT / EXPORT EXCEL.*
...
*Hình 7.10.3: Sơ đồ hoạt động (Activity Diagram) thể hiện quy trình xử lý của chức năng IMPORT / EXPORT EXCEL.*
...
![Cấu trúc giao diện](images/ui_layout_11.png)

*Hình 7.11.1: Bản vẽ thiết kế bố cục giao diện (UI Layout) của chức năng GIỎ HÀNG AJAX.*
...
*Hình 7.11.2: Sơ đồ Use-case mô tả các tác nhân tương tác với chức năng GIỎ HÀNG AJAX.*
...
*Hình 7.11.3: Sơ đồ hoạt động (Activity Diagram) thể hiện quy trình xử lý của chức năng GIỎ HÀNG AJAX.*
...
![Cấu trúc giao diện](images/ui_layout_12.png)

*Hình 7.12.1: Bản vẽ thiết kế bố cục giao diện (UI Layout) của chức năng BỘ LỌC SẢN PHẨM NÂNG CAO (FACETED FILTER).*
...
*Hình 7.12.2: Sơ đồ Use-case mô tả các tác nhân tương tác với chức năng BỘ LỌC SẢN PHẨM NÂNG CAO (FACETED FILTER).*
...
*Hình 7.12.3: Sơ đồ hoạt động (Activity Diagram) thể hiện quy trình xử lý của chức năng BỘ LỌC SẢN PHẨM NÂNG CAO (FACETED FILTER).*
...
![Cấu trúc giao diện](images/ui_layout_13.png)

*Hình 7.13.1: Bản vẽ thiết kế bố cục giao diện (UI Layout) của chức năng SO SÁNH SẢN PHẨM.*
...
*Hình 7.13.2: Sơ đồ Use-case mô tả các tác nhân tương tác với chức năng SO SÁNH SẢN PHẨM.*
...
*Hình 7.13.3: Sơ đồ hoạt động (Activity Diagram) thể hiện quy trình xử lý của chức năng SO SÁNH SẢN PHẨM.*
...
![Cấu trúc giao diện](images/ui_layout_14.png)

*Hình 7.14.1: Bản vẽ thiết kế bố cục giao diện (UI Layout) của chức năng GỢI Ý BÁN CHÉO & COMBO GIÁ ĐỘNG (FBT SUGGESTION).*
...
*Hình 7.14.2: Sơ đồ Use-case mô tả các tác nhân tương tác với chức năng GỢI Ý BÁN CHÉO & COMBO GIÁ ĐỘNG (FBT SUGGESTION).*
...
*Hình 7.14.3: Sơ đồ hoạt động (Activity Diagram) thể hiện quy trình xử lý của chức năng GỢI Ý BÁN CHÉO & COMBO GIÁ ĐỘNG (FBT SUGGESTION).*
...
![Cấu trúc giao diện](images/ui_layout_15.png)

*Hình 7.15.1: Bản vẽ thiết kế bố cục giao diện (UI Layout) của chức năng THANH TOÁN QR ĐỘNG (PAYOS).*
...
*Hình 7.15.2: Sơ đồ Use-case mô tả các tác nhân tương tác với chức năng THANH TOÁN QR ĐỘNG (PAYOS).*
...
*Hình 7.15.3: Sơ đồ hoạt động (Activity Diagram) thể hiện quy trình xử lý của chức năng THANH TOÁN QR ĐỘNG (PAYOS).*
...
![Cấu trúc giao diện](images/ui_layout_16.png)

*Hình 7.16.1: Bản vẽ thiết kế bố cục giao diện (UI Layout) của chức năng TỰ ĐỘNG TÍNH PHÍ VẬN CHUYỂN.*
...
*Hình 7.16.2: Sơ đồ Use-case mô tả các tác nhân tương tác với chức năng TỰ ĐỘNG TÍNH PHÍ VẬN CHUYỂN.*
...
*Hình 7.16.3: Sơ đồ hoạt động (Activity Diagram) thể hiện quy trình xử lý của chức năng TỰ ĐỘNG TÍNH PHÍ VẬN CHUYỂN.*
...
![Cấu trúc giao diện](images/ui_layout_17.png)

*Hình 7.17.1: Bản vẽ thiết kế bố cục giao diện (UI Layout) của chức năng ĐÁNH GIÁ & BÌNH LUẬN ĐỆ QUY.*
...
*Hình 7.17.2: Sơ đồ Use-case mô tả các tác nhân tương tác với chức năng ĐÁNH GIÁ & BÌNH LUẬN ĐỆ QUY.*
...
*Hình 7.17.3: Sơ đồ hoạt động (Activity Diagram) thể hiện quy trình xử lý của chức năng ĐÁNH GIÁ & BÌNH LUẬN ĐỆ QUY.*
...
![Cấu trúc giao diện](images/ui_layout_18.png)

*Hình 7.18.1: Bản vẽ thiết kế bố cục giao diện (UI Layout) của chức năng DANH SÁCH YÊU THÍCH (WISHLIST).*
...
*Hình 7.18.2: Sơ đồ Use-case mô tả các tác nhân tương tác với chức năng DANH SÁCH YÊU THÍCH (WISHLIST).*
...
*Hình 7.18.3: Sơ đồ hoạt động (Activity Diagram) thể hiện quy trình xử lý của chức năng DANH SÁCH YÊU THÍCH (WISHLIST).*
...
![Cấu trúc giao diện](images/ui_layout_19.png)

*Hình 7.19.1: Bản vẽ thiết kế bố cục giao diện (UI Layout) của chức năng SẢN PHẨM ĐÃ XEM GẦN ĐÂY.*
...
*Hình 7.19.2: Sơ đồ Use-case mô tả các tác nhân tương tác với chức năng SẢN PHẨM ĐÃ XEM GẦN ĐÂY.*
...
*Hình 7.19.3: Sơ đồ hoạt động (Activity Diagram) thể hiện quy trình xử lý của chức năng SẢN PHẨM ĐÃ XEM GẦN ĐÂY.*
...
![Cấu trúc giao diện](images/ui_layout_20.png)

*Hình 7.20.1: Bản vẽ thiết kế bố cục giao diện (UI Layout) của chức năng TRA CỨU BẢO HÀNH ĐIỆN TỬ.*
...
*Hình 7.20.2: Sơ đồ Use-case mô tả các tác nhân tương tác với chức năng TRA CỨU BẢO HÀNH ĐIỆN TỬ.*
...
*Hình 7.20.3: Sơ đồ hoạt động (Activity Diagram) thể hiện quy trình xử lý của chức năng TRA CỨU BẢO HÀNH ĐIỆN TỬ.*
...
![Cấu trúc giao diện](images/ui_layout_21.png)

*Hình 7.21.1: Bản vẽ thiết kế bố cục giao diện (UI Layout) của chức năng ĐẶT LỊCH SỬA CHỮA TRỰC TUYẾN (CUSTOMER PORTAL).*
...
*Hình 7.21.2: Sơ đồ Use-case mô tả các tác nhân tương tác với chức năng ĐẶT LỊCH SỬA CHỮA TRỰC TUYẾN (CUSTOMER PORTAL).*
...
*Hình 7.21.3: Sơ đồ hoạt động (Activity Diagram) thể hiện quy trình xử lý của chức năng ĐẶT LỊCH SỬA CHỮA TRỰC TUYẾN (CUSTOMER PORTAL).*
...
![Cấu trúc giao diện](images/ui_layout_22.png)

*Hình 7.22.1: Bản vẽ thiết kế bố cục giao diện (UI Layout) của chức năng AI CHẨN ĐOÁN LỖI (GEMINI VISION).*
...
*Hình 7.22.2: Sơ đồ Use-case mô tả các tác nhân tương tác với chức năng AI CHẨN ĐOÁN LỖI (GEMINI VISION).*
...
*Hình 7.22.3: Sơ đồ hoạt động (Activity Diagram) thể hiện quy trình xử lý của chức năng AI CHẨN ĐOÁN LỖI (GEMINI VISION).*
...
![Cấu trúc giao diện](images/ui_layout_23.png)

*Hình 7.23.1: Bản vẽ thiết kế bố cục giao diện (UI Layout) của chức năng QUẢN LÝ PHIẾU SỬ CHỮA (REPAIR TICKETS).*
...
*Hình 7.23.2: Sơ đồ Use-case mô tả các tác nhân tương tác với chức năng QUẢN LÝ PHIẾU SỬ CHỮA (REPAIR TICKETS).*
...
*Hình 7.23.3: Sơ đồ hoạt động (Activity Diagram) thể hiện quy trình xử lý của chức năng QUẢN LÝ PHIẾU SỬ CHỮA (REPAIR TICKETS).*
...
![Cấu trúc giao diện](images/ui_layout_24.png)

*Hình 7.24.1: Bản vẽ thiết kế bố cục giao diện (UI Layout) của chức năng LIVE TRACKING STEPPER.*
...
*Hình 7.24.2: Sơ đồ Use-case mô tả các tác nhân tương tác với chức năng LIVE TRACKING STEPPER.*
...
*Hình 7.24.3: Sơ đồ hoạt động (Activity Diagram) thể hiện quy trình xử lý của chức năng LIVE TRACKING STEPPER.*
...
![Cấu trúc giao diện](images/ui_layout_25.png)

*Hình 7.25.1: Bản vẽ thiết kế bố cục giao diện (UI Layout) của chức năng XUẤT HÓA ĐƠN DỊCH VỤ SỬ CHỮA.*
...
*Hình 7.25.2: Sơ đồ Use-case mô tả các tác nhân tương tác với chức năng XUẤT HÓA ĐƠN DỊCH VỤ SỬ CHỮA.*
...
*Hình 7.25.3: Sơ đồ hoạt động (Activity Diagram) thể hiện quy trình xử lý của chức năng XUẤT HÓA ĐƠN DỊCH VỤ SỬ CHỮA.*
...
![Cấu trúc giao diện](images/ui_layout_26.png)

*Hình 7.26.1: Bản vẽ thiết kế bố cục giao diện (UI Layout) của chức năng GIAO DIỆN THU NGÂN POS.*
...
*Hình 7.26.2: Sơ đồ Use-case mô tả các tác nhân tương tác với chức năng GIAO DIỆN THU NGÂN POS.*
...
*Hình 7.26.3: Sơ đồ hoạt động (Activity Diagram) thể hiện quy trình xử lý của chức năng GIAO DIỆN THU NGÂN POS.*
...
![Cấu trúc giao diện](images/ui_layout_27.png)

*Hình 7.27.1: Bản vẽ thiết kế bố cục giao diện (UI Layout) của chức năng SPLIT PAYMENT (THANH TOÁN CHIA PHẦN).*
...
*Hình 7.27.2: Sơ đồ Use-case mô tả các tác nhân tương tác với chức năng SPLIT PAYMENT (THANH TOÁN CHIA PHẦN).*
...
*Hình 7.27.3: Sơ đồ hoạt động (Activity Diagram) thể hiện quy trình xử lý của chức năng SPLIT PAYMENT (THANH TOÁN CHIA PHẦN).*
...
![Cấu trúc giao diện](images/ui_layout_28.png)

*Hình 7.28.1: Bản vẽ thiết kế bố cục giao diện (UI Layout) của chức năng IN HÓA ĐƠN NHIỆT (THERMAL PRINTER FORMAT 80MM).*
...
*Hình 7.28.2: Sơ đồ Use-case mô tả các tác nhân tương tác với chức năng IN HÓA ĐƠN NHIỆT (THERMAL PRINTER FORMAT 80MM).*
...
*Hình 7.28.3: Sơ đồ hoạt động (Activity Diagram) thể hiện quy trình xử lý của chức năng IN HÓA ĐƠN NHIỆT (THERMAL PRINTER FORMAT 80MM).*
...
![Cấu trúc giao diện](images/ui_layout_29.png)

*Hình 7.29.1: Bản vẽ thiết kế bố cục giao diện (UI Layout) của chức năng QUẢN LÝ NHÀ CUNG CẤP.*
...
*Hình 7.29.2: Sơ đồ Use-case mô tả các tác nhân tương tác với chức năng QUẢN LÝ NHÀ CUNG CẤP.*
...
*Hình 7.29.3: Sơ đồ hoạt động (Activity Diagram) thể hiện quy trình xử lý của chức năng QUẢN LÝ NHÀ CUNG CẤP.*
...
![Cấu trúc giao diện](images/ui_layout_30.png)

*Hình 7.30.1: Bản vẽ thiết kế bố cục giao diện (UI Layout) của chức năng PHIẾU NHẬP KHO & QUẢN LÝ IMEI.*
...
*Hình 7.30.2: Sơ đồ Use-case mô tả các tác nhân tương tác với chức năng PHIẾU NHẬP KHO & QUẢN LÝ IMEI.*
...
*Hình 7.30.3: Sơ đồ hoạt động (Activity Diagram) thể hiện quy trình xử lý của chức năng PHIẾU NHẬP KHO & QUẢN LÝ IMEI.*
...
![Cấu trúc giao diện](images/ui_layout_31.png)

*Hình 7.31.1: Bản vẽ thiết kế bố cục giao diện (UI Layout) của chức năng ĐỒNG BỘ TỒN KHO ĐA KÊNH.*
...
*Hình 7.31.2: Sơ đồ Use-case mô tả các tác nhân tương tác với chức năng ĐỒNG BỘ TỒN KHO ĐA KÊNH.*
...
*Hình 7.31.3: Sơ đồ hoạt động (Activity Diagram) thể hiện quy trình xử lý của chức năng ĐỒNG BỘ TỒN KHO ĐA KÊNH.*
...
![Cấu trúc giao diện](images/ui_layout_32.png)

*Hình 7.32.1: Bản vẽ thiết kế bố cục giao diện (UI Layout) của chức năng CẢNH BÁO TỒN KHO AN TOÀN (SAFE STOCK ALERT).*
...
*Hình 7.32.2: Sơ đồ Use-case mô tả các tác nhân tương tác với chức năng CẢNH BÁO TỒN KHO AN TOÀN (SAFE STOCK ALERT).*
...
*Hình 7.32.3: Sơ đồ hoạt động (Activity Diagram) thể hiện quy trình xử lý của chức năng CẢNH BÁO TỒN KHO AN TOÀN (SAFE STOCK ALERT).*
...
![Cấu trúc giao diện](images/ui_layout_33.png)

*Hình 7.33.1: Bản vẽ thiết kế bố cục giao diện (UI Layout) của chức năng ĐIỀU CHUYỂN KHO NỘI BỘ.*
...
*Hình 7.33.2: Sơ đồ Use-case mô tả các tác nhân tương tác với chức năng ĐIỀU CHUYỂN KHO NỘI BỘ.*
...
*Hình 7.33.3: Sơ đồ hoạt động (Activity Diagram) thể hiện quy trình xử lý của chức năng ĐIỀU CHUYỂN KHO NỘI BỘ.*
...
![Cấu trúc giao diện](images/ui_layout_34.png)

*Hình 7.34.1: Bản vẽ thiết kế bố cục giao diện (UI Layout) của chức năng KIỂM KÊ & CÂN BẰNG KHO (INVENTORY AUDIT).*
...
*Hình 7.34.2: Sơ đồ Use-case mô tả các tác nhân tương tác với chức năng KIỂM KÊ & CÂN BẰNG KHO (INVENTORY AUDIT).*
...
*Hình 7.34.3: Sơ đồ hoạt động (Activity Diagram) thể hiện quy trình xử lý của chức năng KIỂM KÊ & CÂN BẰNG KHO (INVENTORY AUDIT).*
...
![Cấu trúc giao diện](images/ui_layout_35.png)

*Hình 7.35.1: Bản vẽ thiết kế bố cục giao diện (UI Layout) của chức năng LỊCH SỬ BIẾN ĐỘNG KHO (INVENTORY LOGS).*
...
*Hình 7.35.2: Sơ đồ Use-case mô tả các tác nhân tương tác với chức năng LỊCH SỬ BIẾN ĐỘNG KHO (INVENTORY LOGS).*
...
*Hình 7.35.3: Sơ đồ hoạt động (Activity Diagram) thể hiện quy trình xử lý của chức năng LỊCH SỬ BIẾN ĐỘNG KHO (INVENTORY LOGS).*
...
![Cấu trúc giao diện](images/ui_layout_36.png)

*Hình 7.36.1: Bản vẽ thiết kế bố cục giao diện (UI Layout) của chức năng HẠNG VIP & TÍCH ĐIỂM LOYALTY.*
...
*Hình 7.36.2: Sơ đồ Use-case mô tả các tác nhân tương tác với chức năng HẠNG VIP & TÍCH ĐIỂM LOYALTY.*
...
*Hình 7.36.3: Sơ đồ hoạt động (Activity Diagram) thể hiện quy trình xử lý của chức năng HẠNG VIP & TÍCH ĐIỂM LOYALTY.*
...
![Cấu trúc giao diện](images/ui_layout_37.png)

*Hình 7.37.1: Bản vẽ thiết kế bố cục giao diện (UI Layout) của chức năng ĐỔI THƯỞNG VOUCHER.*
...
*Hình 7.37.2: Sơ đồ Use-case mô tả các tác nhân tương tác với chức năng ĐỔI THƯỞNG VOUCHER.*
...
*Hình 7.37.3: Sơ đồ hoạt động (Activity Diagram) thể hiện quy trình xử lý của chức năng ĐỔI THƯỞNG VOUCHER.*
...
![Cấu trúc giao diện](images/ui_layout_38.png)

*Hình 7.38.1: Bản vẽ thiết kế bố cục giao diện (UI Layout) của chức năng VÒNG QUAY MAY MẮN (LUCKY WHEEL).*
...
*Hình 7.38.2: Sơ đồ Use-case mô tả các tác nhân tương tác với chức năng VÒNG QUAY MAY MẮN (LUCKY WHEEL).*
...
*Hình 7.38.3: Sơ đồ hoạt động (Activity Diagram) thể hiện quy trình xử lý của chức năng VÒNG QUAY MAY MẮN (LUCKY WHEEL).*
...
![Cấu trúc giao diện](images/ui_layout_39.png)

*Hình 7.39.1: Bản vẽ thiết kế bố cục giao diện (UI Layout) của chức năng QUẢN LÝ CHIẾN DỊCH THÔNG BÁO (NOTIFICATION CAMPAIGNS).*
...
*Hình 7.39.2: Sơ đồ Use-case mô tả các tác nhân tương tác với chức năng QUẢN LÝ CHIẾN DỊCH THÔNG BÁO (NOTIFICATION CAMPAIGNS).*
...
*Hình 7.39.3: Sơ đồ hoạt động (Activity Diagram) thể hiện quy trình xử lý của chức năng QUẢN LÝ CHIẾN DỊCH THÔNG BÁO (NOTIFICATION CAMPAIGNS).*
...
![Cấu trúc giao diện](images/ui_layout_40.png)

*Hình 7.40.1: Bản vẽ thiết kế bố cục giao diện (UI Layout) của chức năng AI KIỂM DUYỆT BÀI VIẾT UGC (USER GENERATED CONTENT).*
...
*Hình 7.40.2: Sơ đồ Use-case mô tả các tác nhân tương tác với chức năng AI KIỂM DUYỆT BÀI VIẾT UGC (USER GENERATED CONTENT).*
...
*Hình 7.40.3: Sơ đồ hoạt động (Activity Diagram) thể hiện quy trình xử lý của chức năng AI KIỂM DUYỆT BÀI VIẾT UGC (USER GENERATED CONTENT).*
...
![Cấu trúc giao diện](images/ui_layout_41.png)

*Hình 7.41.1: Bản vẽ thiết kế bố cục giao diện (UI Layout) của chức năng AI DUYỆT ĐƠN HÀNG TỰ ĐỘNG (FRAUD DETECTION).*
...
*Hình 7.41.2: Sơ đồ Use-case mô tả các tác nhân tương tác với chức năng AI DUYỆT ĐƠN HÀNG TỰ ĐỘNG (FRAUD DETECTION).*
...
*Hình 7.41.3: Sơ đồ hoạt động (Activity Diagram) thể hiện quy trình xử lý của chức năng AI DUYỆT ĐƠN HÀNG TỰ ĐỘNG (FRAUD DETECTION).*
...
![Cấu trúc giao diện](images/ui_layout_42.png)

*Hình 7.42.1: Bản vẽ thiết kế bố cục giao diện (UI Layout) của chức năng SỔ QUỸ THU CHI (CASHBOOK).*
...
*Hình 7.42.2: Sơ đồ Use-case mô tả các tác nhân tương tác với chức năng SỔ QUỸ THU CHI (CASHBOOK).*
...
*Hình 7.42.3: Sơ đồ hoạt động (Activity Diagram) thể hiện quy trình xử lý của chức năng SỔ QUỸ THU CHI (CASHBOOK).*
...
![Cấu trúc giao diện](images/ui_layout_43.png)

*Hình 7.43.1: Bản vẽ thiết kế bố cục giao diện (UI Layout) của chức năng VIDEO REVIEW & ĐĂNG TẢI ĐA PHƯƠNG TIỆN.*
...
*Hình 7.43.2: Sơ đồ Use-case mô tả các tác nhân tương tác với chức năng VIDEO REVIEW & ĐĂNG TẢI ĐA PHƯƠNG TIỆN.*
...
*Hình 7.43.3: Sơ đồ hoạt động (Activity Diagram) thể hiện quy trình xử lý của chức năng VIDEO REVIEW & ĐĂNG TẢI ĐA PHƯƠNG TIỆN.*
...
![Cấu trúc giao diện](images/ui_layout_44.png)

*Hình 7.44.1: Bản vẽ thiết kế bố cục giao diện (UI Layout) của chức năng CHẾ ĐỘ ĐA NGÔN NGỮ (LOCALIZATION).*
...
*Hình 7.44.2: Sơ đồ Use-case mô tả các tác nhân tương tác với chức năng CHẾ ĐỘ ĐA NGÔN NGỮ (LOCALIZATION).*
...
*Hình 7.44.3: Sơ đồ hoạt động (Activity Diagram) thể hiện quy trình xử lý của chức năng CHẾ ĐỘ ĐA NGÔN NGỮ (LOCALIZATION).*
...
![Cấu trúc giao diện](images/ui_layout_45.png)

*Hình 7.45.1: Bản vẽ thiết kế bố cục giao diện (UI Layout) của chức năng CHÍNH SÁCH ĐỔI TRẢ & HOÀN TIỀN (RETURNS & REFUNDS).*
...
*Hình 7.45.2: Sơ đồ Use-case mô tả các tác nhân tương tác với chức năng CHÍNH SÁCH ĐỔI TRẢ & HOÀN TIỀN (RETURNS & REFUNDS).*
...
*Hình 7.45.3: Sơ đồ hoạt động (Activity Diagram) thể hiện quy trình xử lý của chức năng CHÍNH SÁCH ĐỔI TRẢ & HOÀN TIỀN (RETURNS & REFUNDS).*
...
![Cấu trúc giao diện](images/ui_layout_46.png)

*Hình 7.46.1: Bản vẽ thiết kế bố cục giao diện (UI Layout) của chức năng AI CHATBOT HỖ TRỢ KHÁCH HÀNG (GEMINI RAG & BOOKING).*
...
*Hình 7.46.2: Sơ đồ Use-case mô tả các tác nhân tương tác với chức năng AI CHATBOT HỖ TRỢ KHÁCH HÀNG (GEMINI RAG & BOOKING).*
...
*Hình 7.46.3: Sơ đồ hoạt động (Activity Diagram) thể hiện quy trình xử lý của chức năng AI CHATBOT HỖ TRỢ KHÁCH HÀNG (GEMINI RAG & BOOKING).*
...
![Cấu trúc giao diện](images/ui_layout_47.png)

*Hình 7.47.1: Bản vẽ thiết kế bố cục giao diện (UI Layout) của chức năng FLASH SALE GIỜ VÀNG & CHỐNG BÁN VƯỢT KHO (ANTI-OVERSELLING).*
...
*Hình 7.47.2: Sơ đồ Use-case mô tả các tác nhân tương tác với chức năng FLASH SALE GIỜ VÀNG & CHỐNG BÁN VƯỢT KHO (ANTI-OVERSELLING).*
...
*Hình 7.47.3: Sơ đồ hoạt động (Activity Diagram) thể hiện quy trình xử lý của chức năng FLASH SALE GIỜ VÀNG & CHỐNG BÁN VƯỢT KHO (ANTI-OVERSELLING).*
...
![Cấu trúc giao diện](images/ui_layout_48.png)

*Hình 7.48.1: Bản vẽ thiết kế bố cục giao diện (UI Layout) của chức năng QUẢN LÝ KHÁCH HÀNG (CRM) & HỆ THỐNG XỬ PHẠT (BANNING SYSTEM).*
...
*Hình 7.48.2: Sơ đồ Use-case mô tả các tác nhân tương tác với chức năng QUẢN LÝ KHÁCH HÀNG (CRM) & HỆ THỐNG XỬ PHẠT (BANNING SYSTEM).*
...
*Hình 7.48.3: Sơ đồ hoạt động (Activity Diagram) thể hiện quy trình xử lý của chức năng QUẢN LÝ KHÁCH HÀNG (CRM) & HỆ THỐNG XỬ PHẠT (BANNING SYSTEM).*
...
![Cấu trúc giao diện](images/ui_layout_49.png)

*Hình 7.49.1: Bản vẽ thiết kế bố cục giao diện (UI Layout) của chức năng QUẢN LÝ BÀI VIẾT & BLOG CÔNG NGHỆ (CRUD ARTICLES).*
...
*Hình 7.49.2: Sơ đồ Use-case mô tả các tác nhân tương tác với chức năng QUẢN LÝ BÀI VIẾT & BLOG CÔNG NGHỆ (CRUD ARTICLES).*
...
*Hình 7.49.3: Sơ đồ hoạt động (Activity Diagram) thể hiện quy trình xử lý của chức năng QUẢN LÝ BÀI VIẾT & BLOG CÔNG NGHỆ (CRUD ARTICLES).*
...
![Cấu trúc giao diện](images/ui_layout_50.png)

*Hình 7.50.1: Bản vẽ thiết kế bố cục giao diện (UI Layout) của chức năng TÙY BIẾN GIAO DIỆN HEADER/FOOTER (THEME CUSTOMIZER).*
...
*Hình 7.50.2: Sơ đồ Use-case mô tả các tác nhân tương tác với chức năng TÙY BIẾN GIAO DIỆN HEADER/FOOTER (THEME CUSTOMIZER).*
...
*Hình 7.50.3: Sơ đồ hoạt động (Activity Diagram) thể hiện quy trình xử lý của chức năng TÙY BIẾN GIAO DIỆN HEADER/FOOTER (THEME CUSTOMIZER).*
...
![Cấu trúc giao diện](images/ui_layout_51.png)

*Hình 7.51.1: Bản vẽ thiết kế bố cục giao diện (UI Layout) của chức năng SMART SETUP WIZARD & CLI ORCHESTRATOR (START.BAT).*
...
*Hình 7.51.2: Sơ đồ Use-case mô tả các tác nhân tương tác với chức năng SMART SETUP WIZARD & CLI ORCHESTRATOR (START.BAT).*
...
*Hình 7.51.3: Sơ đồ hoạt động (Activity Diagram) thể hiện quy trình xử lý của chức năng SMART SETUP WIZARD & CLI ORCHESTRATOR (START.BAT).*
